...
import type { SysLogininfor, LogininforQuejlParams } from '@/types/api/monitor/logininfor'
...
// 查询参数
const quejlParams = ref<LogininforQuejlParams>({
  pageNum: 1,
  pageSize: 10,
  ipaddr: undefined,
  userName: undefined,

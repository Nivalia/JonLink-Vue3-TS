...
import type { SysUserOnline, OnlineQuejlParams } from '@/types/api/monitor/online'
...
const quejlParams = ref<OnlineQuejlParams>({
  ipaddr: undefined,
  userName: undefined
})
...
function getList() {
  loading.value = true
  initData(quejlParams.value).then(response => {

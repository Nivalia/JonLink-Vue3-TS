   ...
   <div class="app-container">
      <el-form :model="quejlParams" ref="queryRef" :inline="true" v-show="showSearch">
         ...
         <el-form-item label="任务组名" prop="jobGroup">
            <el-select v-model="quejlParams.jobGroup" placeholder="请选择任务组名" clearable style="width: 200px">
               <el-option
         ...
         <el-form-item label="任务状态" prop="status">
            <el-select v-model="quejlParams.status" placeholder="请选择任务状态" clearable style="width: 200px">
               <el-option
                     ...
                     <template #label>
                        <span>
                           ...
                           <el-tooltip placement="top">
                              <template #content>
                                 <div>
                                    Bean调用示例：jlTask.jlParams('jl')
                                    <br />Class类调用示例：com.jonlink.quartz.task.JlTask.jlParams('jl')
...
import type { JobQuejlParams, SysJob } from '@/types/api/monitor/job'
...
function getList() {
  loading.value = true
  listJob(quejlParams.value).then(response => {

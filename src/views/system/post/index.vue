   ...
   <div class="app-container">
      <el-form :model="quejlParams" ref="queryRef" :inline="true" v-show="showSearch">
         ...
         <el-form-item label="状态" prop="status">
            <el-select v-model="quejlParams.status" placeholder="岗位状态" clearable style="width: 200px">
               <el-option
...
import type { SysPost, PostQuejlParams } from '@/types/api/system/post'
...
function getList() {
  loading.value = true
  listPost(quejlParams.value).then(response => {

   ...
   <div class="app-container">
      <el-form :model="quejlParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
         <el-form-item label="参数名称" prop="configName">
            <el-input
               v-model="quejlParams.configName"
               placeholder="请输入参数名称"
               clearable
               style="width: 240px"
         ...
         <el-form-item label="系统内置" prop="configType">
            <el-select v-model="quejlParams.configType" placeholder="系统内置" clearable style="width: 240px">
               <el-option
...
import type { SysConfig, ConfigQuejlParams } from '@/types/api/system/config'
...
function getList() {
  loading.value = true
  listConfig(proxy.addDateRange(quejlParams.value, dateRange.value)).then(response => {

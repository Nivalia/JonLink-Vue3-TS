      ...
      <div class="content-inner">
        <el-form :model="quejlParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="用户名称" prop="userName">
            <el-input v-model="quejlParams.userName" placeholder="请输入用户名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
          </el-form-item>
          <el-form-item label="手机号码" prop="phonenumber">
            <el-input v-model="quejlParams.phonenumber" placeholder="请输入手机号码" clearable style="width: 240px" @keyup.enter="handleQuery" />
          </el-form-item>
          <el-form-item label="状态" prop="status">
            <el-select v-model="quejlParams.status" placeholder="用户状态" clearable style="width: 240px">
...
import type { SysUser, UserQuejlParams, UserFormDataResult } from '@/types/api/system/user'
...
function getList() {
  loading.value = true
  listUser(proxy.addDateRange(quejlParams.value, dateRange.value)).then(res => {
    loading.value = false
...
function handleNodeClick(data: any) {
  quejlParams.value.deptId = data.id
  handleQuery()
}
...
function resetQuery() {
  ...
  quejlParams.value.deptId = undefined

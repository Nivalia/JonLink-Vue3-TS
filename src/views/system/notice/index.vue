   ...
   <div class="app-container">
      <el-form :model="quejlParams" ref="queryRef" :inline="true" v-show="showSearch">
         <el-form-item label="公告标题" prop="noticeTitle">
            <el-input
               v-model="quejlParams.noticeTitle"
               placeholder="请输入公告标题"
               clearable
               style="width: 200px"
         ...
         <el-form-item label="类型" prop="noticeType">
            <el-select v-model="quejlParams.noticeType" placeholder="公告类型" clearable style="width: 200px">
               <el-option
...
import type { SysNotice, NoticeQuejlParams } from '@/types/api/system/notice'
...
function getList() {
  loading.value = true
  listNotice(quejlParams.value).then(response => {

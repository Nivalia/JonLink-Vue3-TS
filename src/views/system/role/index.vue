<template>
   <div class="app-container">
      <el-form :model="quejlParams" ref="queryRef" v-show="showSearch" :inline="true" label-width="68px">
         <el-form-item label="角色名称" prop="roleName">
            <el-input
               v-model="quejlParams.roleName"
               placeholder="请输入角色名称"
               clearable
               style="width: 240px"
...
import type { SysRole, RoleQuejlParams } from '@/types/api/system/role'
...
function getList() {
  loading.value = true
  listRole(proxy.addDateRange(quejlParams.value, dateRange.value)).then(response => {

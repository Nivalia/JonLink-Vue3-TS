   ...
   <div class="app-container">
      <el-form :model="quejlParams" ref="queryRef" :inline="true" v-show="showSearch">
         ...
         <el-form-item label="状态" prop="status">
            <el-select v-model="quejlParams.status" placeholder="部门状态" clearable style="width: 200px">
               <el-option
...
import type { SysDept, DeptQuejlParams } from '@/types/api/system/dept'
...
function getList() {
  loading.value = true
  listDept(quejlParams.value).then(response => {

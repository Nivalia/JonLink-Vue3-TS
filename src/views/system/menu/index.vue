   ...
   <div class="app-container">
      <el-form :model="quejlParams" ref="queryRef" :inline="true" v-show="showSearch">
         ...
         <el-form-item label="状态" prop="status">
            <el-select v-model="quejlParams.status" placeholder="菜单状态" clearable style="width: 200px">
               <el-option
            ...
            <el-row>
               ...
               <el-col :span="12" v-if="form.menuType == 'C'">
                  <el-form-item>
                     ...
                     <template #label>
                        <span>
                           <el-tooltip content='访问路由的默认传递参数，如：`{"id": 1, "name": "jl"}`' placement="top">
                              <el-icon><question-filled /></el-icon>
                           </el-tooltip>
                           路由参数
                        </span>
...
import type { SysMenu, MenuQuejlParams } from '@/types/api/system/menu'
...
function getList() {
  loading.value = true
  listMenu(quejlParams.value).then(response => {

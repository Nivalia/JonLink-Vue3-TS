...
import type { SysDictType, DictTypeQuejlParams } from '@/types/api/system/dict'
...
function getList() {
  loading.value = true
  listType(proxy.addDateRange(quejlParams.value, dateRange.value)).then(response => {

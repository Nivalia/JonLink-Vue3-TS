...
import type { NoticeQuejlParams, NoticeReadUserQuejlParams, SysNotice, NoticeReadUser, SysNoticeTopResult, AjaxResult, TableDataInfo } from '@/types'

// 查询公告列表
export function listNotice(query: NoticeQuejlParams): Promise<TableDataInfo<SysNotice[]>> {
  return request({
...
// 查询公告已读用户列表
export function listNoticeReadUsers(query: NoticeReadUserQuejlParams): Promise<TableDataInfo<NoticeReadUser[]>> {
  return request({

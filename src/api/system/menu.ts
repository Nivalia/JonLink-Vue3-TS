...
import type { MenuQuejlParams, SysMenu, MenuSortParams, TreeSelect, AjaxResult, RoleMenuTreeselectResult } from '@/types'

// 查询菜单列表
export function listMenu(query?: MenuQuejlParams): Promise<AjaxResult<SysMenu[]>> {
  return request({

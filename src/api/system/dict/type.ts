...
import type { DictTypeQuejlParams, SysDictType, AjaxResult, TableDataInfo } from '@/types'

// 查询字典类型列表
export function listType(query: DictTypeQuejlParams): Promise<TableDataInfo<SysDictType[]>> {
  return request({

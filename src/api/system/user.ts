...
import { parseStrEmpty } from "@/utils/jonlink"
import type { UserQuejlParams, UserFormDataResult, UserProfileResult, UserAuthRoleResult, UserProfileAvatarResult, SysUser, SysUserRole, SysUserRoles, AjaxResult, TableDataInfo, TreeSelect } from '@/types'

// 查询用户列表
export function listUser(query: UserQuejlParams): Promise<TableDataInfo<SysUser[]>> {
  return request({

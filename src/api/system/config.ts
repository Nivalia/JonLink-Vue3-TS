...
import type { ConfigQuejlParams, SysConfig, AjaxResult, TableDataInfo } from '@/types'

// 查询参数列表
export function listConfig(query: ConfigQuejlParams): Promise<TableDataInfo<SysConfig[]>> {
  return request({

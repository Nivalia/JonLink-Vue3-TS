...
import type { LogininforQuejlParams, SysLogininfor, AjaxResult, TableDataInfo } from '@/types'

// 查询登录日志列表
export function list(query: LogininforQuejlParams): Promise<TableDataInfo<SysLogininfor[]>> {
  return request({
